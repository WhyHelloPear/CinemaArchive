...
namespace Infrastructure.DataAccess.Repositories
{
    public class FilmRepository : IFilmRepository
    {
        ...
        public async Task<int> CreateFilm( Film filmToCreate )
        {
            if( _dbContext.FilmEntities.Any( film => film.IsMatching( filmToCreate ) ) ) {
                return 0;
            }
        ...
        public Task<Result<int>> CreateGenre( Genre genreToCreate )
        {
        ...
        {
            FilmEntity? existingFilm = _dbContext.FilmEntities.FirstOrDefault( f => f.IsMatching( filmToSave ) );
        ...
        {
            GenreEntity? existingGenre = _dbContext.GenreEntities.FirstOrDefault( g => g.IsMatching( genreToSave ) );
